...
- When **Pre-cut DTFs** is on and they confirm build: creates a customer folder in Google Drive and uploads the print PNG + cutter PLT there (PLT is not downloaded in the browser)
