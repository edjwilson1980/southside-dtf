...
const checks = [
  ...
  [css.includes('.cut-reg-mark') && css.includes('border-radius: 50%'), 'overlay crop marks are CSS circles'],
  [overlay.includes('cut-reg-mark'), 'overlay uses circular crop-mark markers'],
